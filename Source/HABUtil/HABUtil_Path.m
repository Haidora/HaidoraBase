...
#import "HABUtil_Path.h"
#include <sys/xattr.h>

@implementation HABUtil_Path
...
{
    return [self filePathInBundle:[NSBundle bundleWithPath:[self documentDirectory]] fileName:filename];
}

+ (NSString *)filePathInCacheDirectory:(NSString *)filename
{
    return [self filePathInBundle:[NSBundle bundleWithPath:[self cacheDirectory]] fileName:filename];
}
